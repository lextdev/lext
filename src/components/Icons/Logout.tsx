...
const SvgLogout = (props: SvgProps) => (
  ...
  >
    <G fill={props.color || `#FFFFFF`} clipPath="url(#a)">
      ...
      <Path d="m22.867 9.879-4.586-4.586a1 1 0 1 0-1.414 1.414l4.262 4.263L6 11a1 1 0 1 0 0 2l15.188-.031-4.323 4.324a1 1 0 1 0 1.414 1.414l4.586-4.586a3 3 0 0 0 .002-4.242Z" />
    </G>
    <Defs>
      <ClipPath id="a">
