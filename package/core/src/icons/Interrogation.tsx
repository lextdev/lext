...
const SvgInterrogation = (props: SvgProps) => (
  ...
  >
    <G fill={props.color || `#FFFFFF`} clipPath="url(#a)">
      ...
      <Path d="M12.717 5.063A4 4 0 0 0 8 9a1 1 0 0 0 2 0 2 2 0 0 1 3.414-1.413c.285.284.48.646.557 1.041a2 2 0 0 1-1 2.125A3.955 3.955 0 0 0 11 14.257V15a1 1 0 0 0 2 0v-.743a1.982 1.982 0 0 1 .93-1.752 4 4 0 0 0-1.213-7.442M13 18a1 1 0 1 0-2 0 1 1 0 0 0 2 0" />
    </G>
    <Defs>
      <ClipPath id="a">
